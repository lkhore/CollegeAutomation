...
<!--[if !IE]--> <html lang="en"> <!--[endif]-->
    ...
    <head>
        ...
        <%            String uid = (String) session.getAttribute("uid");
            ...
            Class.forName("com.mysql.jdbc.Driver");
            java.sql.Connection con1 = connection.start.MyConnection.myConnection();
            Statement st1 = con1.createStatement();

            System.out.println("uid:" + uid);
            String qer = "SELECT MAX(semno) FROM `semreg` WHERE `uid`=?";
            PreparedStatement preparedStatement1 = con1.prepareCall(qer);
            preparedStatement1.setString(1, uid);

            ResultSet res = preparedStatement1.executeQuery();

            boolean flag11211 = false;
            if (res.next()) {

                semno1 = res.getString(1);

                System.out.println("semnos:" + semno1);
...
//
            ...
            if (flag11211 == true) {
                String q2 = " SELECT * FROM `semreg` WHERE uid=? AND `semno`=?";
                ...
                if (rs2.next()) {
                    ...
                    System.out.println("classrollno:" + classrollno);
    ...
    <body>
        ...
        <div id="home3">
            ...
            <form id="field" name="field" method="post" onSubmit="return myValidation();" action="SemRegistration">
                    ...
                    <tr>
                        <td width="632" height="2000"><p align="right"><span class="style2">Enrollment no. :-<strong><font size="+1" >Enroll. no.:-<%=uid%>|Name:-<%=unm%>|<a href="logoutdemo.jsp">LOGOUT</a></font></strong></span></p>
                            ...
                            <p><strong>&nbsp;PERCENTAGE OR GRADE OF LAST SEM -&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="text" name="gread" id="gread" onblur="" maxlength="20" onkeyup="isAlphaNumeric03();" size="20"/><span id=gread1></span> 
                            ...
                            <table width="628" height="155" border="0">
                                ...
                                <tr>
                                    <td height="24"><div align="center">a)<strong>
                                                <input  type="text" name="sub1" id="sub1"  onblur="charlen01(this.id);" maxlength=20 onKeyup="isAlphaNumeric5();" size="20" /><span id=subject1><span>
                                                        </strong></div></td>
                                                        <td><p align="center"><strong>
                                                                    <input type="text" name="subcode1" />
                                                                </strong></p></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <table width="631" height="145" border="0">
                                                            ...
                                                            <tr>
                                                                <td height="24" valign="bottom"><div align="center">a)<strong>
                                                                            <input type="text" name="prat1" id="prat1" onblur="charlen05(this.id);" maxlength="20" onkeyup="isAlphaNumeric05();" size="20"/><span id=sub1></span> 

                                                                        </strong></div></td>
                                                                <td valign="bottom"><div align="center"><strong>
                                                                            <input type="text" name="pratcode1" />
                                                                        </strong></div></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="24" valign="bottom"><div align="center">b)<strong>
                                                                            <input type="text" name="prat2" />
                                                                        </strong></div></td>
                                                                <td valign="bottom"><div align="center"><strong>
                                                                            <input type="text" name="pratcode2" />
                                                                        </strong></div></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="24" valign="bottom"><div align="center">c)<strong>
                                                                            <input type="text" name="prat3" />
                                                                        </strong></div></td>
                                                                <td valign="bottom"><div align="center"><strong>
                                                                            <input type="text" name="pratcode3" />
                                                                        </strong></div></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="24" valign="bottom"><div align="center">d)<strong>
                                                                            <input type="text" name="prat4" />
                                                                        </strong></div></td>
                                                                <td valign="bottom"><div align="center"><strong>
                                                                            <input type="text" name="pratcode4" />
                                                                        </strong></div></td>
                                                            </tr>
                                                        </table>
                                                        <p><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Seminar/Group Discussion&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <input type="text" name="semgd" />
                                                        ...
                                                        <p align="left"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Minor or Major project title&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <input type="text" name="minormajor" />
                                                            </strong><span class="style4">(not for 1st,2nd and 3rd sem)</span></p>
