...
<body>
	...
	<div id="horiz-gallery">
		...
		<div class="gallery">
				...
				<div class="images">
					<div>
						<a href="images/horizontal_gallery/img_01.jpg" data-rel="prettyPhoto[gallery]" title="Image sample title" class="rollover"><img src="images/horizontal_gallery/img_01.jpg" alt="" width="321" height="350" /></a>
			...
			<ul id="sample-menu-3" class="sf-menu sf-vertical">
				...
				<li>
					...
					<ul class="second_level">
						...
						<li><a href="horizontal_gallery.jsp" class="disabled">Horizontal Gallery</a></li>
